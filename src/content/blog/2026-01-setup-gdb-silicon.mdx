...
- gdb needs deep system privileges to inspect and processes
- macos treats this capability as high-risk, preventing malware easily taking over other processes
