...
- access the vm with `lima`

now you can use `gdb` to debug x86_64 binaries on the vm.
...
qemu-x86_64 -g 1234 ./challenge &
gdb -ex 'target remote localhost:1234' -ex 'set architecture i386:x86-64' ./challenge
