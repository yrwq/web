          ...
          [
            rehypePrettyCode,
            {
              ...
              onVisitElement: (node: any) => {
                // Preserve language className on code elements for language detection
                // Only remove non-language classes if needed
                if (
                  node.tagName === "code" &&
                  node.properties &&
                  node.properties.className
                ) {
                  // Keep language-* classes but remove other styling classes if needed
                  ...
                  if (Array.isArray(classNames)) {
                    ...
                    !classNames.startsWith("language-")
                  ) {
                    // Only remove className if it's not a language class
